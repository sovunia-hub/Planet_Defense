...
public class BuildingSystem : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            CircularMenuManager.Instance.MenuElements.Add(BuildingComponents[i].MenuElement);
        }
        CircularMenuManager.Instance.Initialize();
    }
    ...
    private void Update()
    {
        ...
        {
            if (CircularMenuManager.Instance.Active)
            {
                CircularMenuManager.Instance.Deactivate();
            }
            else
            {
                CircularMenuManager.Instance.Activate();
            }
        }

        if (previewing && !CircularMenuManager.Instance.Active)
        {
            ShowPreview();
